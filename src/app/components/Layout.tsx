...
const prestationsSubMenu = [
  ...
  { to: "/education-equine", label: "Éducation équine" },
];
              ...
              if (l.to === "/prestations") {
                return (
                  ...
                  >
                    ...
                    {dropdownOpen && (
                      <div className="absolute top-full left-0 mt-1 bg-[#F5EFE4] shadow-lg border border-[#C09A3C]/15 rounded-sm min-w-[180px] py-1">
