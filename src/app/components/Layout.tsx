      ...
      <footer style={{ background: "#1C1814", borderTop: "1px solid rgba(192,154,60,0.15)" }}>
        <div className="max-w-[1500px] mx-auto px-8 md:px-14 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-right">
            <p className="text-[11px] tracking-wider" style={{ color: "rgba(245,239,228,0.25)" }}>Crédit photo : <span className="text-[#C09A3C]/60">KP Photographies</span></p>
            <a href="https://www.instagram.com/photographies_kp/" target="_blank" rel="noopener noreferrer" className="text-[11px] tracking-wider hover:text-[#C09A3C] transition-colors" style={{ color: "rgba(245,239,228,0.3)" }}>@photographies_kp</a>
          </div>
        </div>
      </footer>
    </div>
